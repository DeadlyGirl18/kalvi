    ...
    <div class="px-4 w-96 xl:w-3/4  border bg-base-300 rounded-3xl border-gray-800 shadow-2xl mx-auto transform transition duration-500 hover:scale-110">
      <div class="max-w-[310px] mx-auto mb-10 mt-10">
        <div class="rounded overflow-hidden mb-8 h-3/5">
          <img src={courseImage} alt="image" class="w-full h-72" />
        </div>
        <div>
          <span
            class="
          ...
          <p class="text-base text-body-color">{courseAuthor}</p>
        </div>
        <div class="flex items-center my-3">
          ...
          <p class="ml-2 text-sm font-medium text-gray-900 dark:text-white">
            {courseRating} out of 5
          </p>
        </div>
        <div className="flex text-white items-center text-xl mt-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-10 w-10"
            fill="none"
          ...
          <span className="ml-2">{coursePrice}</span>
        </div>
      </div>
    </div>
  );
