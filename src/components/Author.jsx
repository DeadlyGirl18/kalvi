...
export function Author({ imgSrc, name }) {
    return (
        <section
            id="author"
        ...
        >
            ...
            <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
                <div className="bg-gray-900 pt-px rounded-3xl">
                    ...
                    <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
                        ...
                        <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-white-800 sm:text-6xl">
                            <span className="block text-white">{name}</span> Hey
                            there, I’m the author behind ‘Introduction to the Angular’.
                        </p>
